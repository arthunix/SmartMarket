...
@set INCLUDES=/I external /I external\backend /I "%WindowsSdkDir%Include\um" /I "%WindowsSdkDir%Include\shared"
@set SOURCES=main.cc external\backend\imgui_impl_dx12.cpp external\backend\imgui_impl_win32.cpp external\imgui*.cpp
